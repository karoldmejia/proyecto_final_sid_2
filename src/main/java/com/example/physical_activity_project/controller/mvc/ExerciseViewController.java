    ...
    import org.springframework.stereotype.Controller; // <-- ¡Importante! No RestController
    ...
    public class ExerciseViewController {
                ...
                public void setAsText(String text) throws IllegalArgumentException {
                    if (text == null || text.trim().isEmpty()) {
                        ...
                        try {
                            ...
                            setValue(null); // Si no es válido, lo deja como nulo
                        }
                    }
                }
        ...
        // TUS MÉTODOS ACTUALES SE MANTIENEN IGUAL...
        @GetMapping
        ...
        public String saveExercise(@ModelAttribute ExerciseDTO exerciseDTO,
            ...
            // Validación manual para evitar el error
